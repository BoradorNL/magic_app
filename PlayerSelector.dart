...
import './CommanderSelector5players.dart';
import './CommanderSelector4players.dart';
import './CommanderSelector3players.dart';
import './CommanderSelector2players.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(25.0, 137.5),
            child: SizedBox(
              width: 310.0,
              height: 66.0,
              child: Text(
                'How many players are you playing with this game?',
                style: TextStyle(
